...
from awslabs.aws_lambda_mcp_server.models import GetLambdaGuidanceRequest
...
async def get_lambda_guidance(request: GetLambdaGuidanceRequest) -> Dict[str, Any]:
    """
    Get guidance on when to use AWS Lambda.
    
    Args:
        request: GetLambdaGuidanceRequest object containing request parameters
    ...
    if request.use_case:
        ...
        elif request.use_case == "data-processing":
            use_case_specific_guidance = UseCaseSpecificGuidance(
        ...
        elif request.use_case == "real-time":
            use_case_specific_guidance = UseCaseSpecificGuidance(
        ...
        elif request.use_case == "scheduled-tasks":
            use_case_specific_guidance = UseCaseSpecificGuidance(
        ...
        elif request.use_case == "mobile-backend":
            use_case_specific_guidance = UseCaseSpecificGuidance(
