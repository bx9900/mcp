...
"""Logging utilities for AWS Serverless MCP Server."""
...
DEFAULT_LOG_DIR = os.path.join(tempfile.gettempdir(), 'aws-serverless-mcp-server-logs')
...
def _configure_root_logger():
    ...
    log_file = os.path.join(LOG_DIR, 'aws-serverless-mcp-server.log')
...
class Logger:
    """Logger class for AWS Serverless MCP Server."""
...
logger = Logger("aws-serverless-mcp-server")
