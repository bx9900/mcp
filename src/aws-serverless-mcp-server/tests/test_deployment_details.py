...
class TestDeploymentDetails:
    ...
    async def test_handle_deployment_details_found(self):
        ...
        with patch(
            ...
            assert result['outputs'] == {"ApiUrl": "https://api.example.com", "FunctionName": "test-function"}
    ...
    async def test_handle_deployment_details_exception(self):
        ...
        with patch(
            ...
            # Verify the result structure
            assert result['success'] is False
            assert f"Failed to get deployment status for project '{project_name}'" in result['message']
    ...
    async def test_handle_deployment_details_failed(self):
        ...
        with patch(
            ...
            assert result['stackStatusReason'] == "Resource creation failed: S3 bucket already exists"