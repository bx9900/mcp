...
class TestDeploymentManagerSimple:
    ...
    async def test_store_deployment_error_basic(self):
        ...
        with patch('awslabs.aws_serverless_mcp_server.utils.deployment_manager.store_deployment_metadata', 
    ...
    async def test_store_deployment_metadata_with_existing_file(self):
        ...
        with patch('builtins.open', mock_open(read_data=json.dumps(existing_metadata))), \
